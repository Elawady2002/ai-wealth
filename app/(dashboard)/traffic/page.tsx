                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-white/10 bg-linear-to-r from-white/5 to-primary/5">
                                ...
                                <th className="text-left p-5 text-xs font-bold text-gray-300 uppercase tracking-wider">Bridge Name</th>
                                <th className="text-left p-5 text-xs font-bold text-gray-300 uppercase tracking-wider">Niche</th>
                                <th className="text-left p-5 text-xs font-bold text-gray-300 uppercase tracking-wider">Date Created</th>
                                <th className="text-left p-5 text-xs font-bold text-gray-300 uppercase tracking-wider">Status</th>
                                <th className="text-right p-5 text-xs font-bold text-gray-300 uppercase tracking-wider">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {loading ? (
                                    ...
                                    <React.Fragment key={bridge.id}>
                                        ...
                                        >
                                            ...
                                            <td className="p-5">
                                                ...
                                                <div className="text-xs text-gray-500 font-mono truncate max-w-[250px] mt-1">{bridge.affiliate_url}</div>
                                            </td>
                                            <td className="p-5">
                                                <motion.button
                                            ...
                                            <td className="p-5">
                                                <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-[10px] font-bold uppercase bg-linear-to-r from-primary/20 to-primary/10 text-primary border border-primary/40 shadow-lg shadow-primary/10">
                                                                            ...
                                                                            {item.comment && (
                                                                                ...
                                                                                >
                                                                                    <textarea
                                                                                        readOnly
                                                                                        value={item.comment}
                                                                                        className="w-full p-3 rounded-lg bg-black/40 border border-white/10 text-sm text-gray-300 resize-none focus:outline-none focus:border-primary/50"
                                                                                        rows={3}
                                                                                    />
                                                                                    <button
