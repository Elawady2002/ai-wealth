...
export default async function ReviewPage({ params, searchParams }: ReviewPageProps) {
    ...
    // Initialize Supabase (prefer Admin client to bypass RLS for public page)
                        ...
                        <div className="relative bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-2xl transition-transform duration-300">
                            ...
                            <div className="relative aspect-4/3 w-full bg-slate-900 flex items-center justify-center overflow-hidden">
                                ...
                                {image_url ? (
                                    ...
                                    <div className="relative z-10 flex flex-col items-center text-white/50">
                                        <div className="w-24 h-24 rounded-full bg-white/10 mb-4 animate-pulse" />
                                        <p className="font-medium">Image Pending...</p>
                                    </div>
                                )}
