...
export function BridgeCard({ id, title, url, status, traffic, earnings }: BridgeCardProps) {
    ...
    return (
        ...
        >
            {/* Toast Notification */}
            {showToast && (
                <div className="absolute top-4 left-1/2 -translate-x-1/2 z-50 bg-primary text-black text-xs font-bold px-4 py-2 rounded-lg shadow-lg animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="p-5 border-b border-white/5 bg-white/2">
                <div className="flex justify-between items-start mb-2">
                    <div className="flex-1 mr-4">
                        <h3 className="font-bold text-lg text-white truncate tracking-wide group-hover:text-primary transition-colors">{title}</h3>
            ...
            <div className="p-5 pt-0 flex gap-3">
                ...
                <button className="h-10 w-10 flex items-center justify-center text-gray-400 hover:text-white bg-white/5 rounded-xl hover:bg-orange-500/10 hover:border-orange-500/30 hover:shadow-[0_0_15px_rgba(249,115,22,0.15)] transition-all duration-300 border border-white/5">
