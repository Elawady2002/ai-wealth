...
import { Zap, LayoutDashboard, Globe, Layers, GraduationCap, Sparkles, Settings, LogOut, Vault, Rocket } from "lucide-react";
...
const navItems = [
    { name: "Command Center", href: "/", icon: LayoutDashboard, color: "primary" },
    { name: "Sync Wizard", href: "/sync", icon: Zap, color: "yellow", highlight: true },
    { name: "My Bridges", href: "/bridges", icon: Layers, color: "purple" },
